...
/**
 * Good People Brewing Scraper
 * https://www.goodpeoplebrewing.com/events
 */
class GoodPeopleBrewingScraper {
  ...
  async scrape() {
    try {
      console.log('Scraping Good People Brewing events...');
      ...
      console.log(`Found ${events.length} Good People Brewing events`);
      return events;
    } catch (error) {
      console.error('Error scraping Good People Brewing:', error.message);
      return [];
    }
  }
  ...
  parseEvent($, element) {
    try {
      ...
      const venue = 'Good People Brewing';
      ...
      console.error('Error parsing Good People Brewing event:', error.message);
      return null;
    }
  }
}

module.exports = GoodPeopleBrewingScraper;
